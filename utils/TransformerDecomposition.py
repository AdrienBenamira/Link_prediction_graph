...
class TransformerDecomposition():

    def __init__(self):

        self.encoder = json.load(open("transformer/model/encoder_bpe_40000.json"))
        merges = open("transformer/model/vocab_40000.bpe", encoding='utf-8').read().split('\n')[1:-1]
    ...
    def apply(self, text):
        ...
        embedding = self.model(tensor_final)[0][:1]
